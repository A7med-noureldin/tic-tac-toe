...
//    cout << "3. Smart Computer (AI)\n";
    ...
    switch(choice) {
        case 1:
            players[0] = new Player_Word<char>(playerXName, 'X');
            break;
        case 2:
            players[0] = new RandomPlayer_Word<char>(player2Name, 'X');
            break;
//        case 3:
//            players[0] = new X_O_MinMax_Player<char>('X');
//            players[0]->setBoard(B);
...
//    cout << "3. Smart Computer (AI)\n";
    ...
    switch(choice) {
        case 1:
            players[1] = new Player_Word<char>(player2Name, 'O');
            break;
        case 2:
            players[1] = new RandomPlayer_Word<char>(player2Name, 'O');
            break;
//        case 3:
//            players[1] = new X_O_MinMax_Player<char>('O');
//            players[1]->setBoard(B);
