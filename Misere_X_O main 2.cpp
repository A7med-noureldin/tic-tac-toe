...
int main() {
    ...
    // Initialize players with the board
    switch(choice1) {
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            players[0] = new X_O_MinMax_Player<char>('X', board);  // Pass board pointer
            break;
        default:
    ...
    switch(choice2) {
        ...
        case 2:
            ...
            break;
        case 3:
            players[1] = new X_O_MinMax_Player<char>('O', board);  // Pass board pointer
            break;
        default:
